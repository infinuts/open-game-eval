...
local eval: BaseEval = {
	scenario_name = "022_add_world_time_bug_2",
	prompt = { "The day/night cycle seems to be running way too fast. It feels like time is speeding up more than it should." },
...
-- Clean up the buggy script introduced by setup
local oldScript = game:GetService("Workspace"):FindFirstChild("TimeController")
if oldScript then
    oldScript:Destroy()
end
